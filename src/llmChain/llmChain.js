...
var promptTemplate = new prompts_1.PromptTemplate({
...
var formattedPrompt = await (function () { return __awaiter(void 0, void 0, void 0, function () {
    var result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, promptTemplate.format({
